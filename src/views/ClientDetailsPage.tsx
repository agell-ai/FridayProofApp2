...
import { InvoiceFormModal } from '../components/Clients/InvoiceFormModal';
import { ProposalFormModal } from '../components/Clients/ProposalFormModal';
...
export const ClientDetailsPage: React.FC<ClientDetailsPageProps> = ({ client, onClose }) => {
